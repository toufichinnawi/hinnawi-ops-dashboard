...
function EquipmentMaintenanceForm({ storeCode: initialStoreCode, storeName: _sn4, positionLabel, onBack }: FormProps) {
  ...
  if (submitted) return <SuccessCard message={`Equipment Maintenance submitted for ${currentStoreName}`} onNew={() => { setSectionChecks({}); setNotes(""); setIssueLog([]); setStaffName(""); setShift(""); setSupervisorName(""); setSubmitted(false); }} onBack={onBack} />;
